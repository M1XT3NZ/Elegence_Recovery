...
void Menu::SubTitle(char* SubTitle) {
	...
	Text(SubTitle, 6, MenuVariables::MenuXCoord, 0.132f, 0.50f, 0.40f, TitleTextRed, TitleTextGreen, TitleTextBlue, TitleTextALPHA, TitleCenter);
}
...
bool Menu::OptionBrk(char* Option)
{
	...
	if (CurrentOption <= 16 && OptionCount <= 16) {
		...
		if (MenuVariables::OptionsCenter)
			Text(Option, OptionsFontBrk, MenuVariables::MenuXCoord, (OptionCount * 0.035f + 0.125f), OptionsScaleBrk, OptionsScaleBrk, OptionsRedBrk, OptionsGreenBrk, OptionsBlueBrk, OptionsALPHABrk, true);
		else
			Text(Option, OptionsFontBrk, (MenuVariables::MenuXCoord - 0.1f), (OptionCount * 0.035f + 0.125f), OptionsScaleBrk, OptionsScaleBrk, OptionsRedBrk, OptionsGreenBrk, OptionsBlueBrk, OptionsALPHABrk, false);
	}

	else if ((OptionCount > (CurrentOption - 16)) && OptionCount <= CurrentOption) {
		if (MenuVariables::OptionsCenter)
			Text(Option, OptionsFontBrk, MenuVariables::MenuXCoord, ((OptionCount - (CurrentOption - 16)) * 0.035f + 0.125f), OptionsScaleBrk, OptionsScaleBrk, OptionsRedBrk, OptionsGreenBrk, OptionsBlueBrk, OptionsALPHABrk, true);
		else
			Text(Option, OptionsFontBrk, (MenuVariables::MenuXCoord - 0.1f), ((OptionCount - (CurrentOption - 16)) * 0.035f + 0.125f), OptionsScaleBrk, OptionsScaleBrk, OptionsRedBrk, OptionsGreenBrk, OptionsBlueBrk, OptionsALPHABrk, false);
	}
...
void Menu::PlayerOption(char* option, int playerNumber, int* selecterPlayer, char** holdName) {
	...
	if (CurrentOption <= 16 && OptionCount <= 16)
		Text("~b~>", OptionsFont, (MenuVariables::MenuXCoord + 0.08f), (OptionCount * 0.035f + 0.125f), OptionsScale, OptionsScale, OptionsRed, OptionsGreen, OptionsBlue, OptionsALPHA, false);
	else if ((OptionCount > (CurrentOption - 16)) && OptionCount <= CurrentOption)
		Text("~b~>", OptionsFont, (MenuVariables::MenuXCoord + 0.08f), ((OptionCount - (CurrentOption - 16)) * 0.035f + 0.125f), OptionsScale, OptionsScale, OptionsRed, OptionsGreen, OptionsBlue, OptionsALPHA, false);
