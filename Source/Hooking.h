...
typedef void(__cdecl* fpsetlobbyweather)(int a1, int a2, int a3, __int64 a4);
typedef int(__cdecl* TriggerScriptEvent)(int unk0, int* args, int argCount, int bitFlags);
typedef bool(__cdecl* fpGetEventData)(int eventGroup, int eventIndex, __int64* argStruct, int argStructSize);
...
public:
	...
	static fpGetEventData			Hooking::get_event_data;
